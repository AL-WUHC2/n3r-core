...
public interface XMLTag {
    ...
    /**
     * Inserts another {@link XMLTag} instance under the current tag. The whole document will be inserted.
     *
     * @param tag The {@link XMLTag} instance to insert
     * @return this
     */
    ...
    /**
     * Inserts another {@link XMLTag} tag hierarchy under the current tag. Only the current tag of the given document
     * will be inserted with its hierarchy, not the whole document.
     *
     * @param tag The {@link XMLTag} current tag hierarchy to insert
     * @return this
     */
    ...
    /**
     * @return A new XMLTag instance having the same properties and documents of the current instance.
