...
public class ArrayConverter extends AbstractConverter {
    ...
    public ArrayConverter(Class defaultType, Converter elementConverter) {
        super();
        if (defaultType == null) { throw new IllegalArgumentException("Default type is missing"); }
        if (!defaultType.isArray()) { throw new IllegalArgumentException("Default type must be an array."); }
        if (elementConverter == null) { throw new IllegalArgumentException("Component Converter is missing."); }
        defaultTypeInstance = Array.newInstance(defaultType.getComponentType(), 0);
    ...
    protected String convertToString(Object value) throws Throwable {
        ...
        if (size == 0) { return (String) getDefault(String.class); }
    ...
    protected Object convertToType(Class type, Object value) throws Throwable {
        ...
        if (!type.isArray()) { throw new ConversionException(toString(getClass())
