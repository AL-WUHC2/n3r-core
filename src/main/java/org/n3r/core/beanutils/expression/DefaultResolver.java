package org.n3r.core.beanutils.expression;
...
public class DefaultResolver implements Resolver {
    ...
    public String getProperty(String expression) {
        ...
        for (int i = 0; i < expression.length(); i++) {
            ...
            else if (c == MAPPED_START || c == INDEXED_START) { return expression.substring(0, i); }
        }
        return expression;
    }
    ...
    public boolean isIndexed(String expression) {
        ...
        for (int i = 0; i < expression.length(); i++) {
            ...
            else if (c == INDEXED_START) { return true; }
        }
        return false;
    }
    ...
    public boolean isMapped(String expression) {
        ...
        for (int i = 0; i < expression.length(); i++) {
            ...
            else if (c == MAPPED_START) { return true; }
        }
        return false;
    }
    ...
    public String next(String expression) {
        ...
        for (int i = 0; i < expression.length(); i++) {
            char c = expression.charAt(i);
            if (indexed) {
                if (c == INDEXED_END) { return expression.substring(0, i + 1); }
            }
            else if (mapped) {
                if (c == MAPPED_END) { return expression.substring(0, i + 1); }
            }
            else {
                if (c == NESTED) {
                    return expression.substring(0, i);
