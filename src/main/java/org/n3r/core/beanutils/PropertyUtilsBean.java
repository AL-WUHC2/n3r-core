...
import org.n3r.core.beanutils.expression.DefaultResolver;
import org.n3r.core.beanutils.expression.Resolver;
import org.n3r.core.collection.FastHashMap;
...
public class PropertyUtilsBean {
    ...
    public Object getIndexedProperty(Object bean, String name)
        ...
        if (bean == null) { throw new IllegalArgumentException("No bean specified"); }
        if (name == null) { throw new IllegalArgumentException("No name specified for bean class '" +
                    bean.getClass() + "'"); }
        ...
        if (index < 0) { throw new IllegalArgumentException("Invalid indexed property '" +
                    name + "' on bean class '" + bean.getClass() + "'"); }
    ...
    public Object getIndexedProperty(Object bean,
        ...
        if (bean instanceof DynaBean) {
            ...
            if (descriptor == null) { throw new NoSuchMethodException("Unknown property '" +
                    name + "' on bean class '" + bean.getClass() + "'"); }
        ...
        if (descriptor instanceof IndexedPropertyDescriptor) {
            ...
            if (readMethod != null) {
                ...
                try {
                    ...
                    if (e.getTargetException() instanceof IndexOutOfBoundsException) { throw (IndexOutOfBoundsException) e
                            .getTargetException(); }
                    throw e;
                }
            }
        ...
        if (readMethod == null) { throw new NoSuchMethodException("Property '" + name + "' has no " +
                    "getter method on bean class '" + bean.getClass() + "'"); }

        // Call the property getter and return the value
        Object value = invokeMethod(readMethod, bean, EMPTY_OBJECT_ARRAY);
        if (!value.getClass().isArray()) {
            if (!(value instanceof java.util.List)) { throw new IllegalArgumentException("Property '" + name +
    ...
    public Object getMappedProperty(Object bean, String name)
        ...
        if (key == null) { throw new IllegalArgumentException("Invalid mapped property '" +
                    name + "' on bean class '" + bean.getClass() + "'"); }
    ...
    public Object getMappedProperty(Object bean,
        ...
        if (name == null) { throw new IllegalArgumentException("No name specified for bean class '" +
                    bean.getClass() + "'"); }
        if (key == null) { throw new IllegalArgumentException("No key specified for property '" +
                    name + "' on bean class " + bean.getClass() + "'"); }
    ...
    public Object getNestedProperty(Object bean, String name)
        ...
        while (resolver.hasNested(name)) {
            ...
            if (nestedBean == null) { throw new NestedNullException("Null property value for '" + name +
    ...
    public PropertyDescriptor getPropertyDescriptor(Object bean,
        ...
        while (resolver.hasNested(name)) {
            ...
            if (nestedBean == null) { throw new NestedNullException("Null property value for '" + next +
                        "' on bean class '" + bean.getClass() + "'"); }
            bean = nestedBean;
            name = resolver.remove(name);
        }
    ...
    public Object getSimpleProperty(Object bean, String name)
        ...
        else if (resolver.isMapped(name)) { throw new IllegalArgumentException(
        ...
        Method readMethod = getReadMethod(bean.getClass(), descriptor);
        if (readMethod == null) { throw new NoSuchMethodException("Property '" + name +
    ...
    public void setSimpleProperty(Object bean,
        ...
        if (writeMethod == null) { throw new NoSuchMethodException("Property '" + name +
