...
public class MappedPropertyDescriptor extends PropertyDescriptor {
    ...
    public MappedPropertyDescriptor(String propertyName, Class beanClass)
        ...
        if (propertyName == null || propertyName.length() == 0) { throw new IntrospectionException(
                "bad property name: " +
        ...
        if (mappedReadMethod == null && mappedWriteMethod == null) { throw new IntrospectionException("Property '"
                + propertyName +
                    "' not found on " +
                    beanClass.getName()); }
    ...
    private void findMappedPropertyType() throws IntrospectionException {
        try {
            ...
            if (mappedReadMethod != null) {
                if (mappedReadMethod.getParameterTypes().length != 1) { throw new IntrospectionException(
                        "bad mapped read method arg count"); }
                mappedPropertyType = mappedReadMethod.getReturnType();
                if (mappedPropertyType == Void.TYPE) { throw new IntrospectionException("mapped read method " +
            ...
            if (mappedWriteMethod != null) {
                ...
                if (mappedPropertyType != null &&
                        mappedPropertyType != params[1]) { throw new IntrospectionException(
    ...
    private static class MappedMethodReference {
        ...
        private Method get() {
            ...
            if (m == null) {
                ...
                if (clazz == null) { throw new RuntimeException("Method " + methodName + " for " +
