...
public class MethodUtils {
    ...
    public static Object invokeMethod(
        ...
        Method method = getMatchingAccessibleMethod(
                ...
                methodName,
                parameterTypes);
        if (method == null) { throw new NoSuchMethodException("No such accessible method: " +
    ...
    public static Method getAccessibleMethod(Class clazz, Method method) {
        ...
        if (clazz == null) {
            ...
            if (!method.getDeclaringClass().isAssignableFrom(clazz)) { throw new IllegalArgumentException(clazz
                    .getName()
                    +
            ...
            if (method2.getName().equals(methodName)) {
                ...
                if (methodParamSize == paramSize) {
                    ...
                    if (match) {
                        ...
                        Method method = getAccessibleMethod(clazz, method2);
                        if (method != null) {
                            setMethodAccessible(method); // Default access superclass workaround
    ...
    private static Method getCachedMethod(MethodDescriptor md) {
        if (CACHE_METHODS) {
            ...
            if (methodRef != null) { return (Method) methodRef.get(); }
        }
        return null;
    }
