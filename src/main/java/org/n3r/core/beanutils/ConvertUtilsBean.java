...
import org.n3r.core.beanutils.converters.ArrayConverter;
import org.n3r.core.beanutils.converters.BigDecimalConverter;
import org.n3r.core.beanutils.converters.BigIntegerConverter;
import org.n3r.core.beanutils.converters.BooleanConverter;
import org.n3r.core.beanutils.converters.ByteConverter;
import org.n3r.core.beanutils.converters.CalendarConverter;
import org.n3r.core.beanutils.converters.CharacterConverter;
import org.n3r.core.beanutils.converters.ClassConverter;
import org.n3r.core.beanutils.converters.ConverterFacade;
import org.n3r.core.beanutils.converters.DateConverter;
import org.n3r.core.beanutils.converters.DoubleConverter;
import org.n3r.core.beanutils.converters.FileConverter;
import org.n3r.core.beanutils.converters.FloatConverter;
import org.n3r.core.beanutils.converters.IntegerConverter;
import org.n3r.core.beanutils.converters.LongConverter;
import org.n3r.core.beanutils.converters.ShortConverter;
import org.n3r.core.beanutils.converters.SqlDateConverter;
import org.n3r.core.beanutils.converters.SqlTimeConverter;
import org.n3r.core.beanutils.converters.SqlTimestampConverter;
import org.n3r.core.beanutils.converters.StringConverter;
import org.n3r.core.beanutils.converters.URLConverter;
...
public class ConvertUtilsBean {
    ...
    public Object convert(Object value, Class targetType) {
        ...
        if (converter != null) converted = converter.convert(targetType, value);
        ...
        if (targetType == String.class && converted != null &&
            ...
            if (converter != null) converted = converter.convert(String.class, converted);

            // If the object still isn't a String, use toString() method
            if (converted != null && !(converted instanceof String)) converted = converted.toString();
    ...
    public Converter lookup(Class sourceType, Class targetType) {
        ...
        if (targetType == null) { throw new IllegalArgumentException("Target type is missing"); }
        if (sourceType == null) { return lookup(targetType); }
