...
public abstract class FieldDeserializer {
    ...
    public abstract void parseField(JSONParser parser, Object object, Type objectType, Map<String, Object> fieldValues);
    ...
    public void setValue(Object object, Object value) {
        ...
        if (method != null) try {
            if (fieldInfo.isGetOnly()) ((Collection) method.invoke(object)).addAll((Collection) value);
            else method.invoke(object, value);
        } catch (Exception e) {
            throw new EsonException("set property error, " + fieldInfo.getName(), e);
        }
