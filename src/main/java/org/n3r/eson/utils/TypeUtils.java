...
public class TypeUtils {
    ...
    public static final Byte castToByte(Object value) {
        ...
        throw new EsonException("can not cast to byte, value : " + value);
    }
    ...
    public static final Character castToChar(Object value) {
        ...
        if (value instanceof String) {
            ...
            if (strVal.length() != 1) throw new EsonException("can not cast to byte, value : " + value);
    ...
    public static final Short castToShort(Object value) {
        ...
        throw new EsonException("can not cast to short, value : " + value);
    }
    ...
    public static final BigInteger castToBigInteger(Object value) {
        ...
        if (value instanceof Float || value instanceof Double) return BigInteger.valueOf(((Number) value).longValue());
    ...
    public static final Float castToFloat(Object value) {
        ...
        throw new EsonException("can not cast to float, value : " + value);
    }
    ...
    public static final Double castToDouble(Object value) {
        ...
        throw new EsonException("can not cast to double, value : " + value);
    }
    ...
    public static final Date castToDate(Object value) {
        ...
        if (value instanceof Number) longValue = ((Number) value).longValue();
        ...
        if (value instanceof String) {
            ...
            if (strVal.indexOf('-') != -1) {
                String format;
                if (strVal.length() == 10) format = "yyyy-MM-dd";
                else if (strVal.length() == "yyyy-MM-dd HH:mm:ss".length()) format = "yyyy-MM-dd HH:mm:ss";
                ...
                try {
                    ...
                    throw new EsonException("can not cast to Date, value : " + strVal);
                }
            }
        ...
        if (longValue <= 0) throw new EsonException("can not cast to Date, value : " + value);
    ...
    public static final java.sql.Date castToSqlDate(Object value) {
        ...
        if (value instanceof Calendar) return new java.sql.Date(((Calendar) value).getTimeInMillis());
    ...
    public static final java.sql.Timestamp castToTimestamp(Object value) {
        ...
        if (value instanceof Calendar) return new java.sql.Timestamp(((Calendar) value).getTimeInMillis());
    ...
    public static final Long castToLong(Object value) {
        ...
        throw new EsonException("can not cast to long, value : " + value);
    }
    ...
    public static final Integer castToInt(Object value) {
        ...
        throw new EsonException("can not cast to int, value : " + value);
    }
    ...
    public static final <T> T castToJavaBean(Object obj, Class<T> clazz) {
        return cast(obj, clazz, ParserMapping.getGlobalInstance());
    }

    @SuppressWarnings({ "unchecked", "rawtypes" })
    public static final <T> T cast(Object obj, Class<T> clazz, ParserMapping mapping) {
        ...
        if (clazz.isArray()) if (obj instanceof Collection) {
        ...
        if (clazz.isEnum()) return castToEnum(obj, clazz, mapping);

        if (Calendar.class.isAssignableFrom(clazz)) {
            Date date = castToDate(obj);
            Calendar calendar;
            if (clazz == Calendar.class) calendar = Calendar.getInstance();
            else try {
                calendar = (Calendar) clazz.newInstance();
            } catch (Exception e) {
                throw new EsonException("can not cast to : " + clazz.getName(), e);
            }
        ...
        throw new EsonException("can not cast to : " + clazz.getName());
    }

    @SuppressWarnings({ "unchecked", "rawtypes" })
    public static final <T> T castToEnum(Object obj, Class<T> clazz, ParserMapping mapping) {
        try {
            if (obj instanceof String) {
            ...
            throw new EsonException("can not cast to : " + clazz.getName(), ex);
        }
    ...
    public static final <T> T cast(Object obj, Type type, ParserMapping mapping) {
        if (obj == null) return null;

        if (type instanceof Class) return cast(obj, (Class<T>) type, mapping);

        if (type instanceof ParameterizedType) return (T) cast(obj, (ParameterizedType) type, mapping);
        ...
        throw new EsonException("can not cast to : " + type);
    }

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public static final <T> T cast(Object obj, ParameterizedType type, ParserMapping mapping) {
        ...
        if (type.getActualTypeArguments().length == 1) {
            ...
            if (argType instanceof WildcardType) return (T) cast(obj, rawTye, mapping);
        }
    ...
    public static final <T> T castToJavaBean(Map<String, Object> map, Class<T> clazz) {
        return castToJavaBean(map, clazz, ParserMapping.getGlobalInstance());
    }

    @SuppressWarnings({ "unchecked" })
    public static final <T> T castToJavaBean(Map<String, Object> map, Class<T> clazz, ParserMapping mapping) {
        try {
            if (clazz == StackTraceElement.class) {
                ...
                int lineNumber;
                {
                    ...
                    if (value == null) lineNumber = 0;
                    else lineNumber = value.intValue();
                }
            ...
            if (clazz.isInterface()) {
                ...
                if (map instanceof JSONObject) object = (JSONObject) map;
                else object = new JSONObject(map);
    ...
    public static void addClassMapping(String className, Class<?> clazz) {
        if (className == null) className = clazz.getName();
    ...
    public static List<FieldInfo> computeGetters(Class<?> clazz, Map<String, String> aliasMap, boolean sorted) {
        ...
        for (Method method : clazz.getMethods()) {
            ...
            if (method.getName().equals("getMetaClass")
                    && method.getReturnType().getName().equals("groovy.lang.MetaClass")) continue;
            ...
            if (methodName.startsWith("get")) {
                ...
                Field field = ParserMapping.getField(clazz, propertyName);
                if (field != null) {
                    EsonField fieldAnnotation = field.getAnnotation(EsonField.class);
            ...
            if (methodName.startsWith("is")) {
                ...
                if (!Character.isUpperCase(methodName.charAt(2))) continue;
        ...
        if (sorted) Collections.sort(fieldInfoList);
